...
**Project:** The Meriden Collection
**Full Business Name:** The Meriden Collection
**ABN:** 92 610 393 957
**Generated:** 2026-06-12 15:56:19
...
|------|-----|--------------|
| Primary | `#E4D9BE` | `--color-primary` |
| Secondary | `#F1EDE4` | `--color-secondary` |
| CTA/Accent | `#2A2927` | `--color-cta` |
| Background | `#FFFFFF` | `--color-background` |
| Text | `#000000` | `--color-text` |

**Color Notes:** Warm neutral palette — cream tones with charcoal CTA on white
